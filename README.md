...
<!-- TODO: 如何利用產生的transition matrices進一步建造simulation data, 有些部分與先前的simulation方式相同只是使用的code不同. 寫出置換了先前code當中的哪一個Input數值 -->
利用generated transition matrices to generate simulation data.  
